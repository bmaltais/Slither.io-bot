...
var canvas = window.canvas = (function (window) {
    return {
        ...
        zoomInOut: function (e) {
            // Scaling ratio
            if (window.gsc) {
                window.gsc *= Math.pow(0.9, e / -120 || e / 2 || 0);
                window.desired_gsc = window.gsc;
            }
        },
    ...
    return {
        ...
        toggleMobileRendering: function (mobileRendering) {
            ...
            if (window.mobileRender) {
                ...
                canvas.setBackground('data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==');
            } else {
